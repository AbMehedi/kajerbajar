// Temporary setup script to create scripts directory and seed file
const fs = require('fs');
const path = require('path');

const scriptsDir = path.join(__dirname, 'scripts');
const seedFile = path.join(scriptsDir, 'seed-test-users.js');
...
// Create seed-test-users.js file
const seedContent = `// scripts/seed-test-users.js
...
console.log('✓ Created seed-test-users.js file');
console.log('\n✅ Setup complete!');
console.log(`\nFiles created:
  - ${scriptsDir}
  - ${seedFile}\n`);
