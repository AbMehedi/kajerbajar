...
export default async function CompanyDashboard() {
  ...
  // Story 3.1: Fetch this company's projects (ordered newest first) for the sidebar card
  ...
  return (
    <div className="gradient-brand min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        ...
        {/* ═══ Story 3.1: Quick Projects Card + Post Button ════════════════════ */}
                ...
                return (
                  ...
                  >
                    <div className="min-w-0">
                      <p className="text-slate-200 text-sm font-medium truncate">{project.title}</p>
                      {deadline && <p className="text-slate-500 text-xs mt-0.5">Due {deadline}</p>}
                    </div>
                    <span className={
                      project.status === 'open'
        ...
        {/* ═══ Phase 3 Complete: Applicant Management Panel ════════════════════ */}
        <div className="mt-6">
